...
if(HPCC_ENABLE_SANITIZE_OPTIONS)
    if(CMAKE_CXX_COMPILER_ID MATCHES "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES "Clang")
        set(HPCC_SANITIZE_COMPILE_OPTIONS "-fsanitize=address;-fsanitize=leak;-fno-omit-frame-pointer")
        if(CMAKE_CXX_COMPILER_ID MATCHES "GNU")
            set(HPCC_SANITIZE_LINK_OPTIONS "${HPCC_SANITIZE_COMPILE_OPTIONS};-static-libasan")
        else()
            set(HPCC_SANITIZE_LINK_OPTIONS "${HPCC_SANITIZE_COMPILE_OPTIONS}")
        endif()
    else()
